      ...
      >
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            ...
            include professional editing and online gallery access.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <div className="rounded-lg p-4 ring-1 ring-accent/15 dark:ring-accent/25 mb-4">
                <h3 className="font-semibold text-gray-900 dark:text-white mb-2 inline-block ring-1 ring-accent/20 dark:ring-accent/30 px-2 py-1 rounded">
                  What's included in the editing?
                </h3>
                <p className="text-gray-600 dark:text-gray-400">
                  All packages include color correction, exposure adjustment,
                  and basic retouching. Premium packages include advanced skin
                  smoothing and object removal.
                </p>
              </div>
              ...
              <div className="rounded-lg p-4 ring-1 ring-accent/15 dark:ring-accent/25">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Delivery times vary by package: Basic (2 weeks), Standard (1
                  week), Premium (5 days), Wedding (2 weeks). Rush delivery
            ...
            <div>
              <div className="rounded-lg p-4 ring-1 ring-accent/15 dark:ring-accent/25 mb-4">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Yes! Travel within Lagos is included. Outside Lagos, travel
                  fees apply based on distance and accommodation needs.
                </p>
              </div>
              ...
              <div className="rounded-lg p-4 ring-1 ring-accent/15 dark:ring-accent/25">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Absolutely! Contact us to discuss your specific needs and
        ...
        >
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            Contact us today to discuss your photography needs and secure your
            preferred date.
          </p>
